...
import com.example.colocacion_en_pantalla.R
import com.example.colocacion_en_pantalla.domain.modelo.Persona
import com.example.colocacion_en_pantalla.domain.usecases.personas.AddPersonaUseCase
import com.example.colocacion_en_pantalla.domain.usecases.personas.GetPersonas
import com.example.colocacion_en_pantalla.ui.pantallaMain.MainState
import com.example.colocacion_en_pantalla.utils.StringProvider
    ...
    fun addPersona(persona: Persona) {
        ...
        if (!addPersonaUseCase(persona)) {
            _uiState.value = MainState(
                error = stringProvider.getString(R.string.error),
            )
