...
public class LoginController extends BasePantallaController {
    ...
    public void initialize() {
        ...
        loginViewModel.getState().addListener((observableValue, oldState, newState) -> {
            ...
            {
                //cambiar de pantalla
                this.getPrincipalController().onLoginHecho(new Reader(txtUserName.getText(), txtPassword.getText()));
            }
    ...
    private void doLogin() {
        Reader reader = new Reader(txtUserName.getText(), txtPassword.getText());

        loginViewModel.doLogin(reader);
